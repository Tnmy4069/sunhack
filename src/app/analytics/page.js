    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <header className="bg-white/70 backdrop-blur-lg border-b border-white/20 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-500 mt-1">Complete insights into your financial patterns</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <Link 
                href="/" 
                className="group bg-slate-100 hover:bg-slate-200 text-slate-700 px-6 py-3 rounded-xl font-medium transition-all duration-200 flex items-center gap-2"
              >
              ...
              <button 
                ...
                className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-2"
              >
                <span>📊</span>
                Export CSV
              </button>
          ...
          {/* Navigation Tabs */}
          <nav className="flex space-x-1 mt-6 bg-slate-100/50 rounded-xl p-1">
            {tabs.map((tab) => (
              <button
                key={tab.id}
          ...
          <div className="mb-8">
            <div className="grid gap-4">
              {insights.slice(0, 3).map((insight, index) => (
                <div 
                  key={index} 
                  className={`relative overflow-hidden p-6 rounded-2xl border shadow-sm backdrop-blur-sm ${
